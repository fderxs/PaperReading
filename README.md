...
在浏览器中打开 `reading_dashboard_<arxiv-scope>.html`。列表页显示已选论文、阅读 ID、已读/未读和精读状态；阅读页右侧是英文 PDF，左侧可在分析 Markdown 与中文 PDF 之间切换。“已读”和“精读”按钮会保存到 `reading_status_<arxiv-scope>.json`。
